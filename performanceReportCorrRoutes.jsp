        ...
        <div class="TitlePanel">
            <div class="row MarginRow">
                <div class="col-sm-9 col-xs-12">
                    <h5 style="padding-right: 12px"><fmt:message key="performanceReportCorrRoutes" /></h5>
                </div>
            </div>
        </div>
        <div id="zcollapse1s" class="panel-collapse collapse in" aria-expanded="true">
            <div class="panel-body">
                <form id="performance_Routes_Form">
                    <div class="tab1">
                        <div class="col-xs-12">
                            <div class="row">
                                 <div class="col-sm-4 col-xs-12">
                                    ...
                                    <select class="select2 validate[required]" id="performance_Routes_Department"  multiple></select>
                                </div>
                                <div class="col-sm-4 col-xs-12">
                                   ...
                                   <!-- <span class="RequiredAstrik">*</span> -->
                                    <select class="select2 " id="performance_Routes_Employee" multiple></select>
                                </div>                                
                                </div>
                                <div class="row">                                      
                                	<div class="col-sm-4 col-xs-12">
										...
										<div class="">
											<div class="col-sm-6 col-xs-12 has-cal">
												<div class="row">
													...
													<div class="col-xs-11">
														<input type="text" id="performance_Routes_DateFrom"
											...
											<div class="col-sm-6 col-xs-12 has-cal">
												<div class="row">
													...
													<div class="col-xs-11">
														<input type="text" id="performance_Routes_DateTo"
															class="form-control popupDatepicker-ml "
															placeholder="yyyy/mm/dd">
													</div>
												</div>
									...
									<div class="row"> 
										<div class="col-sm-2 col-xs-12 ">
											...
											<div class="radio well">
												<label> <input type="radio" name="performance_Routes_reportType" id="performance_Routes_pdf" class="" value="1" checked="checked"><fmt:message key="pdf" />
												</label> <label> <input type="radio" name="performance_Routes_reportType" id="performance_Routes_excel" class="" value="2"><fmt:message key="excel" />
												</label>
											</div>
										</div> 
		                                <div class="col-sm-2 col-sm-2 col-xs-12 marginTop">
		                                    <button type="button" id="performance_Routes_ReportBtn" class="btn btn-primary form-control"><i class="glyphicon glyphicon-search"></i><fmt:message key="reportView" /></button>
		                                </div>
                            	   </div>
                        </div>
                    </div>
